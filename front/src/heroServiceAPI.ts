 ...
 * @version 1.0.2
 * @baseUrl https://localhost:15478/api/v1/heroes
 *
...
> extends HttpClient<SecurityDataType> {
  teams = {
    ...
    /**
     * @description **Deletes** a team (and their associated objects) by their given ID.
     *
     * @tags Teams
    ...
    /**
     * @description For a team with id = {id}, **assign** a team to a human being in the request who is not in one at the moment.
     *
     * @tags Teams
     * @name AddHumanBeingToTeam
     * @summary Assign a human being to a team.
     * @request PATCH:/teams/{id}/add
     */
    addHumanBeingToTeam: (
      id: number,
      query: {
