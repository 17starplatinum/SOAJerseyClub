...
import {HumanBeingService} from '../service/HumanBeingService';
import {WeaponType, Mood, Color, type HumanBeingDTOSchema, type HumanBeingFullSchema} from '../humanBeingAPI';
